...
while cap.isOpened():
    ...
    # Keep only the part of the images without the red color (or any other color you may choose)
    res_1 = cv2.bitwise_and(img, img, mask=mask_2)

    # Keep only the part of the images with the red color (or any other color you may choose)
...
'''
<NOTES>
After the class, check out FourCC - fourcc.org
